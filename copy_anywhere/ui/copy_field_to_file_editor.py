...
class CopyFieldToFileEditor(QWidget):
    ...
    def add_copy_field_row(self, index, copy_field_to_field_definition: CopyFieldToFile):
        ...
        self.file_ui_components[field_guid] = {
            "frame": frame,
    ...
    def remove_definition_by_guid(self, field_guid: str):
        ...
        if field_guid not in self.file_ui_components:
            return

        components = self.file_ui_components[field_guid]
        ...
        if definition in self.field_to_file_defs:
        ...
        del self.file_ui_components[field_guid]
