...
class TestWithinNote:
    def test_a_plain_field_to_field_copy(self, col, note, logger):
    ...
    def test_two_fields_can_be_swapped(self, col, note, logger):
    ...
    def test_copy_if_empty_skips_a_field_that_already_has_a_value(self, note, logger):
        definition = d.within_note(
    ...
    def test_copy_if_empty_fills_a_field_that_is_empty(self, note, logger):
        definition = d.within_note(
    ...
    def test_query_note_index_is_set_to_one_even_in_within_note_mode(self, note, logger):
...
class TestNoSourcesFound:
    def test_without_the_flag_zero_sources_leaves_the_target_field_alone(self, note, logger):
        definition = d.destination_to_sources(
    ...
    def test_with_the_flag_zero_sources_wipes_the_target_field(self, note, logger):
    ...
    def test_the_flag_is_effectively_destination_to_sources_only(self, col, note, logger):
